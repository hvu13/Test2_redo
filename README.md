...
int main(){
    ...
    for(int i=0; i\<str.length(); i++){
        ...
        if(isLetter(c)){
            ...
            if(!isLetter(str[i+1]) && !isDigit(str[i+1])){
                ...
                if(isKeyword(buf)){
                    ...
                    tokens.push\_back({KEYWORD, buf});

                }

                else{

                    tokens.push\_back({IDENTIFIER, buf});
        ...
        // if character is operator
            ...
            tokens.push\_back({OPERATOR, string(1, c)});
        ...
        // if character is separator
            ...
            tokens.push\_back({SEPARATOR, string(1, c)});
